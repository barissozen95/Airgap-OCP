...
0. [Prerequisites and Environment Setup](#0-prerequisites-and-environment-setup)
1. [Phase 1: Prepare Bastion Host](#1-phase-1-prepare-bastion-host)
2. [Phase 2: Install Mirror Registry](#2-phase-2-install-mirror-registry)
3. [Phase 3: Configure HTTP Server](#3-phase-3-configure-http-server)
4. [Phase 4: Download OpenShift Tools](#4-phase-4-download-openshift-tools)
5. [Phase 5: Mirror OpenShift Content](#5-phase-5-mirror-openshift-content)
6. [Phase 6: Push Content to Mirror Registry](#6-phase-6-push-content-to-mirror-registry)
7. [Phase 7: Prepare vSphere Environment](#7-phase-7-prepare-vsphere-environment)
8. [Phase 8: Install OpenShift Cluster](#8-phase-8-install-openshift-cluster)
9. [Phase 9: Post-Installation Configuration](#9-phase-9-post-installation-configuration)
...
### 0.1 VMware vSphere Environment
...
### 0.2 Required Red Hat Credentials
...
## 1. Phase 1: Prepare Bastion Host
...
## 2. Phase 2: Install Mirror Registry

### 2.1 Generate TLS Certificate
...
### 2.2 Download Mirror Registry Installer
...
## 4. Phase 4: Download OpenShift Tools

### 4.1 Install OpenShift Client (oc)
...
### 4.3 Install OpenShift Installer
...
## 5. Phase 5: Mirror OpenShift Content
...
### 5.3 Create ImageSetConfiguration
...
## 6. Phase 6: Push Content to Mirror Registry

### 6.1 Login to Mirror Registry

```bash
podman login 192.168.252.2:8443 --tls-verify=false
```

### 6.2 Push Mirrored Content
...
## 7. Phase 7: Prepare vSphere Environment

### 7.1 Import vCenter CA Certificate
...
### 7.2 Verify vCenter Connectivity
...
## 8. Phase 8: Install OpenShift Cluster

### 8.1 Generate Install Configuration
...
### 8.2 Customize Install Configuration
...
### 8.3 Create Installation Directory
...
## 9. Phase 9: Post-Installation Configuration
...
### 9.2 Disable Default OperatorHub Sources
...
### 9.3 Apply Mirror Configuration
...
### 10.4 Missing Operator Dependencies
